...
public class UpdatePasswordFrame extends JDialog{
     ...
     */
    public UpdatePasswordFrame(JFrame owner, String title, boolean modal,Manager manager){
        ...
        confirm_Button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(repassword.equals(newpassword)){
                    ...
                    if(helper.Login(manager)){//检查原密码是否正确
                        helper.update_Password(manager, newpassword);	//修改密码
